...
class LecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecture" do
    assert_difference("Lecture.count") do
      post lectures_url, params: { lecture: { lecture_end: @lecture.lecture_end, lecture_start: @lecture.lecture_start, title: @lecture.title } }
    end
  ...
  test "should update lecture" do
    patch lecture_url(@lecture), params: { lecture: { lecture_end: @lecture.lecture_end, lecture_start: @lecture.lecture_start, title: @lecture.title } }
